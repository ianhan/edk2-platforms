...
MISC_SMBIOS_TABLE_FUNCTION(MiscSystemManufacturer)
{
  ...
  //
  AsciiStrToUnicodeStrS ((CHAR8 *) PcdGetPtr(PcdSMBIOSSystemManufacturer), Manufacturer, SMBIOS_STRING_MAX_LENGTH);
  ...
  AsciiStrToUnicodeStrS ((CHAR8 *) PcdGetPtr(PcdSMBIOSSystemProductName), ProductName, SMBIOS_STRING_MAX_LENGTH);
  ...
  AsciiStrToUnicodeStrS ((CHAR8 *) PcdGetPtr(PcdSMBIOSSystemVersion), Version, SMBIOS_STRING_MAX_LENGTH);
  if (StrLen (Version) > 0) {
  ...
  AsciiStrToUnicodeStrS ((CHAR8 *) PcdGetPtr(PcdSMBIOSSystemSerialNumber), SerialNumber, SMBIOS_STRING_MAX_LENGTH);
  ...
  AsciiStrToUnicodeStrS ((CHAR8 *) PcdGetPtr(PcdSMBIOSSystemSKUNumber), SKUNumber, SMBIOS_STRING_MAX_LENGTH);
  ...
  AsciiStrToUnicodeStrS ((CHAR8 *) PcdGetPtr(PcdSMBIOSSystemFamily), Family, SMBIOS_STRING_MAX_LENGTH);
  if (StrLen (Family) > 0) {
