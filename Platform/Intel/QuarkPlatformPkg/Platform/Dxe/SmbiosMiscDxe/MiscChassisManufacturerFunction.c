...
MISC_SMBIOS_TABLE_FUNCTION(MiscChassisManufacturer)
{
  ...
  //
  AsciiStrToUnicodeStrS ((CHAR8 *) PcdGetPtr(PcdSMBIOSChassisManufacturer), Manufacturer, SMBIOS_STRING_MAX_LENGTH - 1);
  ...
  AsciiStrToUnicodeStrS ((CHAR8 *) PcdGetPtr(PcdSMBIOSChassisVersion), Version, SMBIOS_STRING_MAX_LENGTH - 1);
  if (StrLen (Version) > 0) {
  ...
  AsciiStrToUnicodeStrS ((CHAR8 *) PcdGetPtr(PcdSMBIOSChassisSerialNumber), SerialNumber, SMBIOS_STRING_MAX_LENGTH - 1);
  ...
  AsciiStrToUnicodeStrS ((CHAR8 *) PcdGetPtr(PcdSMBIOSChassisAssetTag), AssertTag, SMBIOS_STRING_MAX_LENGTH - 1);
